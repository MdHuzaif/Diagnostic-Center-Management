...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-6 mb-5 element-animate">
            <form action="{{url('/save-doctor')}}" method="post">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" name="doctor_name" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="Doctor Designation:">Designation:</label>
                  <input type="text" name="qualification" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="Doctor Specalist:">Specialist:</label>
                  <input type="text" name="specialist" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="Doctor Fees:">Doctor Fees</label>
                  <input type="text" name="doctor_fees" class="form-control form-control-lg" required="">
                </div>
              </div>
             
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Add Doctor" class="btn btn-primary btn-lg btn-block">
                </div>
