  ...
  <body>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
               ...
               <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Administration</a>
    ...
    <!-- END header -->
     ...
     <p class="alert-success" style="text-align: center";>
                      ...
                      $message=Session::get('invalid_message');
                    
                        if($message){
                           echo $message;
                        
                          Session::put('invalid_message',null);
                         }
                         ?>
                      </p>
    <div class="col-md-6 mb-5 element-animate">
            <form action="{{url('/confirm-reception')}}" method="post">

              {{csrf_field()}}

              <div class="row">
                <div class="col-md-12 form-group">
                  <label for=" ">Receptionist Name:</label>
                  <input type="text" name="reception_name" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Receptionist Phone:</label>
                  <input type="text" name="reception_phone" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="Doctor Specalist:">Receptionist Address:</label>
                  <input type="text" name="reception_address" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Receptionist UserName:</label>
                  <input type="text" name="reception_username" class="form-control form-control-lg" required="">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Receptionist Password:</label>
                  <input type="password" name="reception_password" class="form-control form-control-lg" required="">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Admin UserName:</label>
                  <input type="text" name="admin_username" class="form-control form-control-lg" required="">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Admin Password:</label>
                  <input type="Password" name="admin_password" class="form-control form-control-lg" required="">
                </div>
              </div>
             
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Add Receptionist" class="btn btn-primary btn-lg btn-block">
                </div>
