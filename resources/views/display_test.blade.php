        ...
        <div class="box span12">
          ...
          <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
             ...
             @foreach($all_test_info as $d_test)
              <tbody>
              <tr>
                <td>{{$d_test->test_name}}</td>
                <td class="center">{{$d_test->test_price}}</td>
                 <td class="center">
                  <a class="btn btn-info" href="{{URL::to('/update-test/'.$d_test->test_id)}}">
                    <i class="halflings-icon white edit"></i>  
                  </a>
                  <a class="btn btn-danger" href="{{URL::to('/delete-test/'.$d_test->test_id)}}" id="delete">
