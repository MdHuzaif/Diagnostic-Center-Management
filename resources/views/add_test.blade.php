...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-6 mb-5 element-animate">
            <form action="{{url('/save-test')}}" method="post">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" name="test_name" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="Doctor Designation:">Test Price:</label>
                  <input type="text" name="test_price" class="form-control form-control-lg" required="">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Add NewTest" class="btn btn-primary btn-lg btn-block">
                </div>
