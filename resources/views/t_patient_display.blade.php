        ...
        <div class="box span12">
          ...
          <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
             ...
             @foreach($all_t_patient_info as $t_patient)
              <tbody>
              <tr>
                <td>{{$t_patient->t_patient_name}}</td>
                <td class="center">{{$t_patient->t_patient_contact}}</td>
                <td class="center">{{$t_patient->t_patient_serial}}</td>
                 <td class="center">{{$t_patient->t_patient_testname}}</td>
                 <td class="center">{{$t_patient->t_patient_total}}</td>
                 <td class="center">{{$t_patient->t_patient_due}}</td>
                 <td class="center">{{$t_patient->t_patient_discount}}</td>
                  <td class="center">{{$t_patient->t_patient_deliverydate}}</td>
                 <td class="center">
                  <a class="btn btn-info" href="{{URL::to('/update-t-patient/'.$t_patient->t_patient_id)}}">
                    <i class="halflings-icon white edit"></i>  
                  </a>
                  <a class="btn btn-danger" href="{{URL::to('/delete-t-patient/'.$t_patient->t_patient_id)}}" id="delete">
