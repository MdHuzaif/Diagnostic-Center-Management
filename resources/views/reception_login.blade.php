...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url(login/img/reception.jpg) !important; }
		</style>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2>Login to your account(Reception)</h2>
					<form class="form-horizontal" action="{{url('/reception-dashboard')}} " method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="reception_username" type="text" placeholder="type username"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="reception_password"  type="password" placeholder="type password"/>
							</div>
