        ...
        <div class="box span12">
          ...
          <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
             ...
             @foreach($all_reception_info as $d_reception)
              <tbody>
              <tr>
                <td>{{$d_reception->reception_name}}</td>
                <td class="center">{{$d_reception->reception_phone}}</td>
                <td class="center">{{$d_reception->reception_address}}</td>
                 <td class="center">{{$d_reception->reception_username}}</td>
                 <td class="center">
                  <a class="btn btn-info" href="{{URL::to('/update-reception/'.$d_reception->reception_id)}}">
                    <i class="halflings-icon white edit"></i>  
                  </a>
                  <a class="btn btn-danger" href="{{URL::to('/delete-reception/'.$d_reception->reception_id)}}" id="delete">
