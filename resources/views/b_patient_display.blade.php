        ...
        <div class="box span12">
          ...
          <div class="box-content">
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
             ...
             @foreach($all_b_patient_info as $b_patient)
              <tbody>
              <tr>
                <td>{{$b_patient->b_patient_name}}</td>
                <td class="center">{{$b_patient->b_patient_serial}}</td>
                <td class="center">{{$b_patient->b_patient_date}}</td>
                 <td class="center">{{$b_patient->b_patient_time}}</td>
                 <td class="center">{{$b_patient->b_patient_contact}}</td>
                 <td class="center">{{$b_patient->b_patient_payment}}</td>
                 <td class="center">{{$b_patient->b_patient_due}}</td>
                  <td class="center">{{$b_patient->doctor_name}}</td>
                 <td class="center">
                  <a class="btn btn-info" href="{{URL::to('/update-b-patient/'.$b_patient->b_patient_id)}}">
                    <i class="halflings-icon white edit"></i>  
                  </a>
                  <a class="btn btn-danger" href="{{URL::to('/delete-b-patient/'.$b_patient->b_patient_id)}}" id="delete">
