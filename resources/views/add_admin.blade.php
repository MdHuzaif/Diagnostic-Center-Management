...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Doctors</a>
    ...
    <div class="col-md-6 mb-5 element-animate">
            <form action="{{url('/save-newadmin')}}" method="post">

              {{csrf_field()}}

              <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">New Admin UserName:</label>
                  <input type="text" name="newadmin_email" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">New Admin Password:</label>
                  <input type="Password" name="newadmin_password" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
                  <label for="">Admin UserName:</label>
                  <input type="text" name="admin_email" class="form-control form-control-lg" required="">
                </div>
              </div>
               <div class="row">
                <div class="col-md-12 form-group">
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="submit" value="Add NewAdmin" class="btn btn-primary btn-lg btn-block">
                </div>
